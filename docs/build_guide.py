...
L["fr"] = dict(
  ...
  trouble=[
    ...
    ("usage … is outside the plausible range", "Presque toujours un <strong>compteur bi-horaire</strong> : l’afficheur tient deux registres (<span class=\"k\">1.8.1</span> heures creuses et <span class=\"k\">1.8.2</span> heures pleines) et votre photo en a saisi un seul, alors que votre lecteur rapporte le total des deux — le point de départ et le lecteur ne sont donc pas à la même échelle. Dans l’app, sous <span class=\"k\">Auto-received</span>, appuyez sur <strong>&ldquo;Use this reading as my starting point&rdquo;</strong>. Cela ne paie rien et ne fait que fixer où commence le comptage. Possible jusqu’à votre premier versement automatique."),
...
L["es"] = dict(
  ...
  trouble=[
    ...
    ("usage … is outside the plausible range", "Casi siempre un <strong>contador de doble tarifa</strong>: la pantalla lleva dos registros (<span class=\"k\">1.8.1</span> valle y <span class=\"k\">1.8.2</span> normal) y tu foto capturó uno de ellos, mientras que tu lector informa la suma de ambos — el punto de partida y el lector están en escalas distintas. En la app, bajo <span class=\"k\">Auto-received</span>, pulsa <strong>&ldquo;Use this reading as my starting point&rdquo;</strong>. No paga nada y solo fija dónde empieza el conteo. Posible hasta tu primer pago automático."),
